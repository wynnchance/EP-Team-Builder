[README.md](https://github.com/user-attachments/files/29831296/README.md)
[README.md](https://github.com/user-attachments/files/29831026/README.md)
# ⚔ E&P Team Builder
...
**📋 My Roster** — select which heroes you own from a searchable, filterable list. Add heroes not yet in the database by pasting their skill text; roles are auto-detected.
